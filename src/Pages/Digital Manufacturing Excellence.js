    ...
    return (
        <div>
            ...
            <div className=' bg-black' >
                ...
                <section className='lg:py-36 py-16'>
                    <div className='lg:flex lg:mx-16'>
                        <div data-aos="zoom-in" data-aos-duration="3000" className='lg:w-1/2 p-5 my-auto'>
                            <h1 className='lg:text-6xl md:text-3xl text-xl  lg:text-start text-center   font-bold font-sans text-[#FD5A2A] lg:leading-[5rem] leading-10'> Digital Manufacturing Excellence<span className='lg:text-6xl text-xl md:text-3xl lg:text-start text-white text-center font-bold font-sans lg:leading-[4.5rem] md:mt-3 lg:mt-0  leading-9 tracking-wide'> that Scale With Your Business</span></h1>
                            <p className='lg:text-lg  lg:mt-5 mt-3 lg:leading-[1.9rem] leading-6.5 text-gray-300 tracking-wide  text-justify'>Achieve digital manufacturing excellence with AattralOne's innovative solution. Our comprehensive platform integrates advanced technologies such as IoT, AI, and digital twins to transform manufacturing operations, optimize processes, and drive business growth.</p>
                        </div>
                ...
                <section className=' lg:py-24 py-10'>
                    ...
                    <div className='lg:p-10 p-5 mt-5'>
                        <div className='flex flex-wrap justify-center gap-16'>
                            {Asset.slice(39, 44).map((assetItem, index) => (
                ...
                <section>
                    {Asset.slice(44, 52).map((assetItem, index) => (
                    ...
                    <div data-aos="zoom-in" data-aos-duration="3000" className='lg:py-16'>
                        <div className='grid lg:grid-cols-2 lg:mx-36 lg:py-10  lg:my-16 my-8  mx-5 py-5 lg:gap-10    rounded-md shadow-[0_3px_10px_rgb(0,0,0,0.2)] border-[#FD5A2A] border-2' style={{ fontFamily: '"League spartan",sans-serif' }}>
                            <div className='my-auto lg:mx-2 mx-5 lg:p-12'>
                                ...
                                <p className='lg:text-xl lg:mt-4 md:font-semibold lg:leading-8 text-[#747578] ' style={{ letterSpacing: '0.5px' }}>Contact us today to discover how AattralOne's Digital Manufacturing Excellence solution can transform your manufacturing operations and drive business success.</p>
                            </div>
                            <InpuField />
                        </div>
                    </div>
